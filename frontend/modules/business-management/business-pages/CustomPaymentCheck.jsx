...
import { FaArrowLeft, FaLock, FaCheckCircle, FaShieldAlt } from "react-icons/fa";
    ...
    const handleContinue = async () => {
        ...
        try {
            ...
            if (type === "course") {
                ...
                description = `Gift payment: ${itemName || "Digital AELA"} - ${giftType === "near" ? "Gift to near one" : "Gift to anyone"}`;
            }

            // Step 1: Create payment record
            const paymentResponse = await createPayment({
                courseId: paymentData.type === "course" ? paymentData.itemId : undefined,
                ...
                <div className="max-w-3xl mx-auto px-4 md:px-8">
                    ...
                    >
                                    ...
                                    <span className="text-white font-semibold text-right max-w-[60%] flex flex-col items-end">
                                        ...
                                        {paymentData.description && (
                                            <p className="text-xs text-gray-500 font-normal mt-1 italic text-left w-full">
                                                <TranslatedText>{paymentData.description}</TranslatedText>
                                            </p>
                                        )}
                                    </span>
                                </div>
                        ...
                        <motion.button
                            ...
                            className={`w-full py-4 rounded-lg font-bold text-lg transition-all duration-200 ${acceptedTerms

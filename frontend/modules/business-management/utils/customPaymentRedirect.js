...
export const redirectToCustomCoursePayment = (course) => {
    ...
    if (course.rawPrice !== undefined && course.rawPrice !== null) {
        ...
        // Extract number from string like "AED 500" or "500"
    ...
    redirectToCustomPayment("course", {
        ...
        level: course.level,
        description: truncateWords(course.shortDescription || course.description || course.summary || "", 100),
    });
};
...
export const redirectToCustomBookPayment = (book) => {
    ...
    if (typeof book.price === 'number') {
        ...
        // Extract number from string like "AED 50" or "50"
        const match = book.price.match(/[\d.]+/);
        numericAmount = match ? parseFloat(match[0]) : 0;
    }
    ...
    redirectToCustomPayment("book", {
        ...
        author: book.author,
        format: book.format,
        description: truncateWords(book.shortDescription || book.description || book.fullDescription || "", 100),
    });
};

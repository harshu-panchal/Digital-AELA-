...
const courseCatalog = [
  {
    ...
    description:
      "Upskill teams with high-impact communication, leadership and productivity programmes crafted for global workplaces.",
    icon: <FaChalkboardTeacher className="h-5 w-5 text-[#F5D26A]" />,
  ...
  },
  {
    ...
    description:
      "Master performance marketing, content strategy and analytics with live projects led by senior strategists.",
    icon: <FaLaptop className="h-5 w-5 text-[#F5D26A]" />,
    highlights: ["360° campaign studio", "AI toolkits", "Placement support"],
    path: "/courses/digital-marketing",
  },
  {
    title: "English Language",
    description:
      "Transform fluency, accent and confidence with immersive labs for students, professionals and global citizens.",
    icon: <FaGlobe className="h-5 w-5 text-[#F5D26A]" />,
    highlights: ["IELTS masteries", "Accent labs", "Public speaking studio"],
    path: "/courses/english-language",
  },
  {
    title: "Career Counselling & Skill Development",
    description:
      "Design career blueprints with psychometric guidance, job-ready skills and mentorship from industry leaders.",
    icon: <FaArrowRight className="h-5 w-5 text-[#F5D26A]" />,
    highlights: ["Future skills roadmap", "1:1 mentorship pods", "Global career clinics"],
    path: "/courses/career-counselling-skill-development",
  },
];
          ...
          <div className="layout-container">
            <div className="mx-auto mb-12 max-w-3xl text-center">
              <motion.h2
                ...
                Four signature course ecosystems to anchor your centre
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 16 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                Each track connects live labs, on-demand content, and certification pathways curated for community impact.
              </motion.p>
            </div>

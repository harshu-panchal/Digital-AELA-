...
const StudentLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020409] text-white">
      <SEO
        title="Student Login | Digital AELA"
        description="Student login portal for Digital AELA. Access classes, assignments, and progress reports."
        keywords="student login, learning portal, Digital AELA"
        url="https://digitalaela.com/login/student"
      />

...
const BranchOwnerLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020409] text-white">
      <SEO
        title="Branch Owner Login | Digital AELA"
        description="Login for Digital AELA branch owners to manage centre operations, teams, and performance dashboards."
        keywords="branch owner login, centre management, Digital AELA"
        url="https://digitalaela.com/login/branch-owner"
      />
      ...
      <main className="relative z-10 flex min-h-screen items-center justify-center px-4 py-20 mt-20">
        <motion.div
          ...
          <div className="space-y-3 text-center">
            ...
            <h1 className="text-3xl font-semibold text-white sm:text-4xl">Lead Your Digital AELA Centre</h1>
            <p className="text-sm text-slate-300/80">
              Sign in to track enrolments, mentor performance, finances, and local campaigns tailored to your region.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <label className="block space-y-2">
              ...
              <input
                ...
                placeholder="branch@digitalaela.com"
          ...
          <div className="text-center text-xs text-slate-300/70">
            Looking to launch a centre?{" "}
            <motion.a
              whileHover={{ x: 2 }}
              href="/register/branch-owner"
              className="text-[#F5D26A] underline-offset-2 hover:text-[#FFE28A]">
              Apply as a branch owner
            </motion.a>
          </div>
        </motion.div>
      </main>
...
export default BranchOwnerLogin;

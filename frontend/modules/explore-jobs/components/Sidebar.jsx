...
const ExploreJobsSidebar = ({ onCreatePost, isOpen = true }) => {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex w-[260px] shrink-0 border-r border-white/5 bg-[#050505]/80 backdrop-blur-xl flex-col">
        <SidebarContent />
      </aside>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            className="fixed left-0 top-0 h-screen w-[260px] shrink-0 border-r border-white/5 bg-[#050505]/80 backdrop-blur-xl z-50 md:hidden flex flex-col">
            <SidebarContent />
          </motion.aside>
        )}
      </AnimatePresence>

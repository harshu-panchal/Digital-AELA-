...
const DownloadInvoice = () => {
  ...
  const handleDownloadPDF = () => {
    ...
    window.open(
      `${backendUrl}/payments/${paymentId}/invoice?format=pdf`,
      "_blank"
    );
  };
      ...
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">
            <TranslatedText>Loading invoice details...</TranslatedText>
          </p>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <div className="text-center p-8 bg-[#111] rounded-2xl border border-white/10 max-w-md w-full">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">
            <TranslatedText>Invoice Not Found</TranslatedText>
          </h2>
          <p className="text-gray-400 mb-6">
            <TranslatedText>
              We couldn't find the invoice details you're looking for.
            </TranslatedText>
          </p>
          <button
            onClick={() => navigate(-1)}
  ...
  return (
    <div className="min-h-screen bg-black py-6 sm:py-12 px-4 print:bg-white print:py-0">
      <SEO
        title={`Invoice ${invoice.invoiceNumber} | Digital AELA`}
          ...
          <div className="p-6 sm:p-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-12 sm:mb-16">
              ...
              <div className="md:text-right space-y-2 w-full md:w-auto">
                <h2 className="text-3xl sm:text-4xl font-black text-[#D4AF37] tracking-tight">
                  <TranslatedText>INVOICE</TranslatedText>
                </h2>
                <div className="text-gray-400 space-y-1 print:text-gray-600 text-sm sm:text-base">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16 border-t border-white/5 pt-12 print:border-gray-100">
              <div className="space-y-4">
                <h3 className="text-xs sm:text-sm uppercase tracking-[0.2em] text-[#D4AF37] font-black">
                  <TranslatedText>Bill To</TranslatedText>
                </h3>
                <div className="space-y-2">
                  <p className="text-xl sm:text-2xl font-bold text-white print:text-black">
                    {invoice.user.name}
                  </p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/5 rounded-2xl p-5 border border-white/10 print:bg-gray-50 print:border-gray-200">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span
                      className={`px-3 py-1 rounded-lg text-[10px] sm:text-xs font-black tracking-widest border ${
                  ...
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-white print:text-black font-bold uppercase text-sm">
                  ...
                  {invoice.payment.gatewayTransactionId && (
                    <div className="flex justify-between items-center">
                      <span className="text-gray-400 print:text-gray-600 text-sm">
                        <TranslatedText>Trans ID</TranslatedText>
                      </span>
                      <span className="text-[#D4AF37] print:text-black font-mono text-[10px] sm:text-xs break-all ml-4 text-right">
                        {invoice.payment.gatewayTransactionId}
                      </span>
                    </div>
                  )}
              ...
              <table className="w-full min-w-[500px] sm:min-w-0">
                <thead>
                  <tr className="border-b border-white/10 print:border-gray-200">
                    <th className="text-left py-4 text-[10px] sm:text-xs font-black text-gray-500 uppercase tracking-[0.2em] print:text-gray-600">
                      <TranslatedText>Description</TranslatedText>
                    </th>
                    <th className="text-right py-4 text-[10px] sm:text-xs font-black text-gray-500 uppercase tracking-[0.2em] print:text-gray-600">
            ...
            <div className="flex justify-end mb-12 sm:mb-16">
              <div className="w-full sm:w-80 space-y-4">
                ...
                <div className="flex justify-between text-gray-400 print:text-gray-600 text-sm sm:text-base">
                  <span className="font-medium text-gray-500">
                    <TranslatedText>Tax (0%)</TranslatedText>
                  </span>
                  <span className="font-bold text-white print:text-black">
                    {formatCurrency(0)}
                  </span>
                ...
                <div className="pt-6 border-t border-white/10 print:border-gray-200">
                  <div className="flex justify-between items-center">
                    <span className="text-lg sm:text-xl font-black text-white print:text-black uppercase tracking-wider">
                      <TranslatedText>Total Amout</TranslatedText>
                    </span>
            ...
            <div className="border-t border-white/5 pt-12 text-center space-y-6 print:border-gray-100">
              <div className="flex items-center justify-center gap-3 text-emerald-400 bg-emerald-400/5 py-3 px-6 rounded-2xl border border-emerald-400/10 w-fit mx-auto">
                ...
                <span className="text-[10px] sm:text-xs font-black tracking-[0.2em] uppercase">
                  <TranslatedText>Securely Processed payment</TranslatedText>
                </span>
              </div>
              <p className="text-gray-500 text-xs sm:text-sm max-w-md mx-auto print:text-gray-400 leading-relaxed">
                <TranslatedText>
                  Thank you for choosing Digital AELA. If you have any questions
                  regarding this invoice, please contact our support team.
                </TranslatedText>
              </p>
              <div className="pt-4 flex items-center justify-center gap-6 grayscale opacity-30">
                <div className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#D4AF37]" />
                  <span className="text-[10px] font-black text-white uppercase tracking-[0.34em] print:text-black">
                    Digital AELA
                  </span>
                </div>
              </div>

...
const DoubtTicketList = () => {
  ...
  return (
    <div className="min-h-screen text-white">
      <SEO title="My Doubt Tickets | Digital AELA" description="View and manage your doubt tickets" />

      <div className="space-y-10">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-semibold mb-2">My Doubt Tickets</h1>
            <p className="text-slate-400">Ask questions and get help from teachers</p>
          </div>
          <Link
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 rounded-3xl border border-white/10 bg-[#060A17]/90">
            ...
            <p className="text-slate-400 mb-4">No doubt tickets found</p>
            <Link
              to="/student/doubt-tickets/create"
          ...
          <div className="space-y-4">
            {tickets.map((ticket) => (
              <Link
                key={ticket._id}
                to={`/student/doubt-tickets/${ticket._id}`}
                className="block">
                <motion.div
...
export default DoubtTicketList;

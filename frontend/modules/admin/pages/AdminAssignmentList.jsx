...
const AdminAssignmentList = () => {
  ...
  const loadCourses = async () => {
    ...
    try {
      // For super-admin, get all courses
  ...
  return (
    <div className="min-h-screen bg-[#03040B] text-white">
      <SEO title="Assignments | Super Admin | Digital AELA" description="Manage all assignments across the platform" />

      <div className="layout-container py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-semibold mb-2">Assignments</h1>
            <p className="text-slate-400">Manage assignments across all courses</p>
          </div>
          <button
            onClick={() => navigate("/super-admin/assignments/create")}
          ...
          <div className="grid gap-4">
            {assignments.map((assignment) => (
              <motion.div
                ...
                onClick={() => navigate(`/super-admin/assignments/${assignment._id}`)}
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm text-slate-300">
                      ...
                      {assignment.instructor && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-white">{assignment.instructor?.fullName || "N/A"}</span>
                        </div>
                      )}
                      <div className="flex items-center gap-2">

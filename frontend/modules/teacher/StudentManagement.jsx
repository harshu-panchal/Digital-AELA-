...
const StudentManagement = () => {
  ...
  useEffect(() => {
    if (!isAuthenticated || !user || (user.role !== "teacher" && user.role !== "admin")) {
      toast.info("Only teachers can manage students");
      navigate("/");
      return;
    }

    loadStudents();
  }, [isAuthenticated, user, navigate, pagination.page, filters, courseId]);
  ...
  return (
    <div className="min-h-screen bg-[#03040B] text-white">
      <SEO
        title={courseId ? "Course Students | Digital AELA" : "Student Management | Digital AELA"}
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <h1 className="text-3xl font-semibold md:text-4xl">
                  {courseId ? "Enrolled Students" : "All Students"}
                </h1>
              </div>
            </div>
          </motion.header>
                    ...
                    {courseId ? (
                      <div className="space-y-2">
                          ...
                          <>
                            <div className="flex items-center justify-between text-sm">
                              ...
                              <span className="font-semibold text-white">
                                {student.progress.lessonCompletions}
                              </span>
                            </div>
                            {student.progress.avgQuizScore !== null && (
                              <div className="flex items-center justify-between text-sm">
                                <span className="text-slate-400">Quiz Avg:</span>
                                <span className="font-semibold text-white">
                                  {student.progress.avgQuizScore}%
                                </span>
                              </div>
                            )}
                          </>
                        ...
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="text-slate-300">{formatDate(student.enrolledAt)}</span>
                        </div>
                      </div>
                    ) : (
                      <div className="space-y-2">

...
const AnnouncementList = () => {
  ...
  return (
    <div className="min-h-screen text-white">
      <SEO title="Announcements | Digital AELA" description="Manage your announcements" />

      <div className="space-y-10">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-semibold mb-2">My Announcements</h1>
            <p className="text-slate-400">Create and manage announcements for your students</p>
          </div>
          <Link
              ...
              <motion.div
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="ml-6 flex flex-col gap-2">
                    <Link
                      to={`/teacher/announcements/${announcement._id}`}

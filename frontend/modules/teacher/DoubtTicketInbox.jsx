...
const DoubtTicketInbox = () => {
  ...
  return (
    <div className="min-h-screen text-white">
      <SEO title="Doubt Ticket Inbox | Digital AELA" description="View and manage student doubt tickets" />

      <div className="space-y-10">
        <div>
          <h1 className="text-3xl font-semibold mb-2">Doubt Ticket Inbox</h1>
          <p className="text-slate-400">View and respond to student questions</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {tickets.map((ticket) => (
              <Link key={ticket._id} to={`/teacher/doubt-tickets/${ticket._id}`} className="block">
                <motion.div
...
export default DoubtTicketInbox;

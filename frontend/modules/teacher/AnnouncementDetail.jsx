    ...
    <div className="min-h-screen text-white">
      ...
      <div className="space-y-10">
        ...
        {announcement.targetCourses && announcement.targetCourses.length > 0 && (
          <div className="rounded-2xl border border-white/10 bg-[#060A17]/90 p-6">
            <h2 className="text-xl font-semibold text-white mb-4">Target Courses</h2>
        ...
        {announcement.status === "draft" && (
          <div className="flex gap-4">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl border border-red-500/40 bg-red-500/20 text-red-300 font-semibold hover:bg-red-500/30 transition">
              Delete
            </button>
          </div>
        )}

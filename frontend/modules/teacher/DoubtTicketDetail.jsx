...
const DoubtTicketDetail = () => {
  ...
  const loadTicket = async () => {
    ...
    try {
      ...
      navigate("/teacher/doubt-tickets");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen text-white">
      <SEO title={`${ticket.title} | Digital AELA`} description="View doubt ticket details" />

      <div className="space-y-10">
        <div className="flex items-center gap-4">
          <button
            onClick={() => navigate("/teacher/doubt-tickets")}
        ...
        {ticket.replies && ticket.replies.length > 0 && (
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">Replies ({ticket.replies.length})</h2>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="font-semibold text-white">{reply.user?.fullName || "User"}</span>
...
export default DoubtTicketDetail;
